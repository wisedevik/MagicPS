namespace MagicPS.Titan.DataStream
{
    ...
    public class ChecksumEncoder
    {
        ...
        {
            this.m_checksum = (value ? 13 : 7) + this.__ROR4__(this.m_checksum, 31);
        }

        public virtual void WriteByte(byte value)
        {
            this.m_checksum = value + this.__ROR4__(this.m_checksum, 31) + 11;
        }

        public virtual void WriteShort(short value)
        {
            this.m_checksum = value + this.__ROR4__(this.m_checksum, 31) + 19;
        }

        public virtual void WriteInt(int value)
        {
            this.m_checksum = value + this.__ROR4__(this.m_checksum, 31) + 9;
        }
        ...
        public virtual void WriteLongLong(long value)
        {
            ...
            this.m_checksum = high + this.__ROR4__(low + this.__ROR4__(this.m_checksum, 31) + 67, 31) + 91;
        }
        ...
        {
            this.m_checksum = (value != null ? value.Length + 28 : 27) + this.__ROR4__(this.m_checksum, 31);
        }

        public virtual void WriteStringReference(string value)
        {
            this.m_checksum = value.Length + this.__ROR4__(this.m_checksum, 31) + 38;
        }
